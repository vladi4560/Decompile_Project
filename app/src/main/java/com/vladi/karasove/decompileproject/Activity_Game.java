package com.vladi.karasove.decompileproject;
...
public class Activity_Game extends AppCompatActivity {
    ...
    private void findViews() {
        this.arrows = new ImageButton[]{(ImageButton) findViewById(R.id.game_BTN_left),// 0
                (ImageButton) findViewById(R.id.game_BTN_right), // 1
                (ImageButton) findViewById(R.id.game_BTN_up), // 2
                (ImageButton) findViewById(R.id.game_BTN_down)};// 3
